...
potential_users['day_of_week'] = potential_users['day_of_week'].astype(str)
potential_users['count'] = pd.to_numeric(potential_users['count'], errors='coerce')

df_real_users['day_of_week'] = df_real_users['day_of_week'].astype(str)
df_real_users['count'] = pd.to_numeric(df_real_users['count'], errors='coerce')
...
def store_user_analysis(postal_code: str) -> None:
    ...
    df_store_potential_users['day_of_week'] = df_store_potential_users['day_of_week'].astype(str)
    df_store_potential_users['count'] = pd.to_numeric(df_store_potential_users['count'], errors='coerce')

    df_store_real_users['day_of_week'] = df_store_real_users['day_of_week'].astype(str)
    df_store_real_users['count'] = pd.to_numeric(df_store_real_users['count'], errors='coerce')
