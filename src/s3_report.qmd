...
-   Total Población:El día con más usuarios es el lunes, por el contrario, el día con menos usuarios es el domingo

-   Usuarios Bait: El día con más usuarios es el lunes, por el contrario, el día con menos usuarios es el domingo
...
# Tienda bottom: `{python} df_bait_users_per_store.tail(n=1)["Nombre"][0]`

Esta tienda es del formato `{python} df_bait_users_per_store.tail(n=3)["Formato"][0]`, la cual tiene `{python} df_bait_users_per_store.tail(n=3)["Clientes_reales"][0]` usuarios Bait.

-   Total Población:El día con más usuarios es el sábado, por el contrario, el día con menos usuarios es el jueves

-   Usuarios Bait: El día con más usuarios es el martes, por el contrario, el día con menos usuarios es el jueves
